      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="asset/backend/pages/forms/general.html"><i class="fa fa-circle-o"></i> Semua Post</a></li>
            <li><a href="asset/backend/pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Tambah Baru</a></li>
            <li><a href="asset/backend/pages/forms/editors.html"><i class="fa fa-circle-o"></i> Kategori</a></li>
            <li><a href="asset/backend/pages/forms/editors.html"><i class="fa fa-circle-o"></i> Tag</a></li>
            
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Jamaah Aero</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="asset/backend/pages/tables/simple.html"><i class="fa fa-circle-o"></i>Semua Jamaah</a></li>
            <li><a href="asset/backend/pages/tables/data.html"><i class="fa fa-circle-o"></i>Tambah Baru</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Mitra</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="asset/backend/pages/tables/simple.html"><i class="fa fa-circle-o"></i>Semua Mitra</a></li>
            <li><a href="asset/backend/pages/tables/data.html"><i class="fa fa-circle-o"></i>Tambah Baru</a></li>
          </ul>
        </li>
        <li>
        ...
        <li><a href="asset/backend/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
